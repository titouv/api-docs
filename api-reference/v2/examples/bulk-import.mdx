...
As an example, the following [stash](/api-reference/v2/stashing/post-stashes-serial) request bodies will create a final dataset consisting of the two rows identified by the stash ID `20240501-import`.

`POST /stashes/20240501-import/1`
...
`POST /stashes/20240501-import/2`
