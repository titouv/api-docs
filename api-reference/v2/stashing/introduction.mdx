...
Please see the specific endpoint's documentation for more details on how to use a stash reference:
...
Stashing is a general purpose capability, but it is particular useful in a few known use-cases. Please see our tutorials for more details:

* [Bulk Import](/api-reference/v2/examples/bulk-import)